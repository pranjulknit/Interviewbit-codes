...
// Note :- If a meeting ends at time t, another meeting starting at time t
//  can use the same conference room
...
//  Meeting three can be done in conference room 2 form 15 - 20 as it is 
//  free in this interval.
// Explanation 2:
...
//  Meeting three can be done in conference room 2 from 15 - 29 as it is free 
//  in this interval.
//  Meeting two can be done in conference room 4 from 18 - 23 as it is free in 
//  this interval.
...
int Solution::solve(vector<vector<int> > &A) {
    ...
    for(int i=0;i<A.size();i++){
        int start = A[i][0];
        int end = A[i][1];
        // if start is less then ending of any meeting
